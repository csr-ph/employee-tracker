// import ctable for displaying databse tables in terminal
const cTable = require('console.table');
// import connection
const database = require('../../db/connection');

// class for handling actions involving employees
class Employees {
    async getAllEmployees() {
        try {
            ...
            console.log('Error attempting to show employees. It is probably my fault.')
        }
    }
